...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user\PycharmProjects\flask_first_project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user\PycharmProjects\flask_first_project\Scripts\deactivate.nu'
